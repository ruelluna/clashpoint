  ...
  return (
    <form action={action}>
      ...
      <Flex gap={2} align="center" wrap="wrap">
        ...
        />
        <Button type="submit" size="sm" loading={pending} disabled={!!item.weightVerifiedAt}>
          Record
        </Button>
      </Flex>
      {state.error ? (
      ...
      <Stack gap={LAYOUT_GAP.form} mt={4}>
        ...
        <form action={recordAction}>
          ...
          <Flex gap={LAYOUT_GAP.form} direction={{ base: 'column', sm: 'row' }} align="end">
            ...
            <Button type="submit" loading={recordPending} alignSelf="flex-end">
              Save inspection
            </Button>
          </Flex>
          {recordState.error ? (
        ...
        {item.inspectionId ? (
          <Flex gap={2} wrap="wrap">
            <form action={approveAction}>
              ...
              <Button size="sm" colorPalette="green" type="submit" loading={approvePending}>
                Approve
              </Button>
            </form>
            <form action={rejectAction} style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
              ...
              <Textarea
                ...
                maxW="xs"
              />
              <Button size="sm" colorPalette="red" type="submit" loading={rejectPending}>
                Reject
              </Button>
            </form>
